...
namespace EfCoreTestSuite.IntentGenerated.Entities
{
    ...
    public partial class N_OwnedEntity : IN_OwnedEntity
    {
        ...
        private ICollection<N_OwnedEntityAssociationA> _n_OwnedEntityAssociationAS;

        public virtual ICollection<N_OwnedEntityAssociationA> N_OwnedEntityAssociationAS
        {
            get
            {
                return _n_OwnedEntityAssociationAS ??= new List<N_OwnedEntityAssociationA>();
            }
            set
            {
                _n_OwnedEntityAssociationAS = value;
            }
        }
